                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">院系教务管理人员</strong>
                                    </span>
                                </span>
                        </a>
                        </div>
                        <div class="logo-element">院系教务管理人员</div>
                    </li>
                    <li class="line dk"></li>
                    <li>
                        <a class="J_menuItem" href="/MyPaper/getFamInfo">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">个人信息</span>
                    </a></li>
					  <li>
                        <a class="J_menuItem" href="admin/fm_articlestage.jsp">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">发布论文阶段信息</span>
                        </a>
                    </li>
                  <li>
                        <a class="J_menuItem" href="admin/fm_titleinfo.jsp">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">发布选题</span>
                        </a>
                  </li>
                    <li>
                        <a class="J_menuItem" href="admin/fm_score.jsp">
                        <i class="fa fa-envelope"></i> 
                        <span class="nav-label">提交答辩分数 </span>
                        </a> 
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="admin/fm_notice.jsp">公告信息发布</a>
                            </li>
