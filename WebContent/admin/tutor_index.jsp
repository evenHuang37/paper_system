...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">导师</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">导师
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="/MyPaper/getTutorInfo">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/MyPaper/GetLoad">毕业论文套表</a>
                            </li>
                    ...
                    <li>
                        ...
                        <span class="nav-label">系统留言表 </span>
                        <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/MyPaper/tutorToMsg">给毕业生留言</a>
                            </li>
                            <li><a class="J_menuItem" href="/MyPaper/getTutorMessage">我的留言列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">毕业生毕业设计</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/MyPaper/getStdArticle">毕业生毕业设计</a>
                            </li>
                       <li><a class="J_menuItem" href="/MyPaper/score">毕业生论文成绩</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <!-- 第三方插件 -->
    <script src="admin/sjs/plugins/pace/pace.min.js"></script>
